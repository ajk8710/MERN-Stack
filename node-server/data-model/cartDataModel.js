...
let CartModel = mongooseObj.model("cart", cartSchema);  // cart - collection name (table name), pluralised by mongodb

module.exports = CartModel;  // this should be used in cartRouter to build cart api's
