...
let UserHook = () => {
    ...
    let [studentName, setStudentName] = useState("Initial Student");
...
// 1. implement using useRef in StudentHook and save student info to DB
// 2. implement using useState way as we did
